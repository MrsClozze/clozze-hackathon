  ...
  return (
    <header className="h-16 bg-background border-b border-border flex items-center justify-end px-6 z-50">
      ...
      <div className="flex items-center gap-4">
        ...
        {/* Upload File Button */}
        <button className="flex items-center gap-2 relative bg-gradient-to-r from-purple-600/30 via-pink-500/30 to-cyan-400/30 backdrop-blur-md text-white hover:from-purple-500/50 hover:via-pink-400/50 hover:to-cyan-300/50 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 border-2 border-transparent hover:border-white/50 shadow-lg hover:shadow-2xl hover:shadow-purple-500/25 before:absolute before:inset-0 before:rounded-lg before:bg-gradient-to-r before:from-violet-500/20 before:via-fuchsia-500/20 before:to-cyan-500/20 before:opacity-0 hover:before:opacity-100 before:transition-opacity before:duration-300 overflow-hidden group">
          ...
          <div className="absolute -inset-1 bg-gradient-to-r from-purple-500 via-pink-500 to-cyan-500 rounded-lg opacity-0 group-hover:opacity-40 blur-sm transition-opacity duration-300"></div>
          <Upload className="h-4 w-4 relative z-10 drop-shadow-lg" />
          <span className="relative z-10 font-bold">Upload File</span>
        </button>
