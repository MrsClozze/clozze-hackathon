      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        {view === "manual" && (
          <form onSubmit={handleManualSubmit} className="space-y-6 py-4">
            ...
            {/* Listing Description */}
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-text-heading">Listing Description</h3>
              <div>
                <Label htmlFor="description">MLS Description</Label>
                <Textarea
                  id="description"
                  name="description"
                  value={formData.description}
                  onChange={(e) => updateFormField("description", e.target.value)}
                  placeholder="Enter or paste the property listing description..."
                  className="mt-1 min-h-[140px] resize-y"
                  rows={6}
                />
                <p className="text-xs text-muted-foreground mt-1.5">
                  This can be auto-generated by Clozze AI or edited manually.
                </p>
              </div>
            </div>
