...
const trainingScenarios = [
  {
    id: 1,
    type: "text",
    question: "Respond to a general client who just finished their first consultation and wants to know the next steps.",
    placeholder: "Type your response here...",
  },
  {
    id: 2,
    type: "text",
    question: "Respond to this text: 'Congratulations! Your buyer, Sarah Johnson, just got approved for $800,000 with your preferred lender.'",
    placeholder: "Type your response here...",
  },
  {
    id: 3,
    type: "text",
    question: "Draft an email to a buyer explaining that the home they wanted received multiple offers and they were not the winning bid.",
    placeholder: "Type your email here...",
  },
  {
    id: 4,
    type: "text",
    question: "Draft a promotional email to announce a new listing going live next week.",
    placeholder: "Type your email here...",
  },
  {
    id: 5,
    type: "text",
    question: "Draft a message to a listing client recommending a price reduction.",
    placeholder: "Type your message here...",
  },
  {
    id: 6,
    type: "text",
    question: "Respond to an email from a preferred lender asking for a copy of a client's pre-approval letter.",
    placeholder: "Type your response here...",
  },
  {
    id: 7,
    type: "text",
    question: "Draft an email to a Title Company confirming the closing date and requesting an updated HUD statement.",
    placeholder: "Type your email here...",
  },
  {
    id: 8,
    type: "text",
    question: "Respond to a co-worker who needs you to cover an open house this weekend.",
    placeholder: "Type your response here...",
  },
  {
    id: 9,
  ...
  },
  {
    ...
    question: "Do you have a preferred email address for professional communications?",
  },
];
